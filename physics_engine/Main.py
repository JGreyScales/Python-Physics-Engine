...
def gameloop():
    ...
    key_strokes = [pygame.K_1, pygame.K_2, pygame.K_3, pygame.K_4, pygame.K_5, pygame.K_6, pygame.K_7, pygame.K_8, pygame.K_9, pygame.K_0, pygame.K_PERIOD]
                    ...
                    if event.key == pygame.K_BACKSPACE:
                        ...
                        for key in key_strokes:
                            if event.key == key: 
                                ...
                                else: user_text += str(key_strokes.index(key+1))
                                break
